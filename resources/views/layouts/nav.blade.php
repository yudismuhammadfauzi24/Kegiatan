<nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @endrole
                    @role('bendahara')
                    <a class="nav-link text-white" href="{{route('verifikasi-pendaftaran')}}">Verifikasi Pendaftaran</a>
                    @endrole
                    @role('student')
                    <a class="nav-link text-white" href="{{route('kegiatan.tampilkan')}}">Cek Kegiatan</a>
                    @endrole
                    </ul>
